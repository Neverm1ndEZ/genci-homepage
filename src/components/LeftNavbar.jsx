		...
		<div className=" text-blue-600 dark:text-gray-50 bg-gray-800  h-screen fixed">
			...
			<nav className="hidden lg:flex w-24 h-screen dark:bg-gray-800 flex-col items-center py-8">
				<ul className="flex flex-col gap-9">
					<Link href="/homepage" className="text-white h-8">
						<Button color="inherit">
							<span className="material-symbols-rounded">home</span>
						</Button>
					</Link>
					<Link href="/homepage/courses" className="text-white h-8">
						<Button color="inherit">
							<span className="material-symbols-rounded">school</span>
						</Button>
					</Link>
					<Link href="/homepage/analytics" className="text-white h-8">
						<Button color="inherit">
							<span className="material-symbols-rounded">leaderboard</span>
						</Button>
					</Link>
					<Link href="/homepage/notifications" className="text-white h-8">
						<Button color="inherit">
							<span className="material-symbols-rounded">notifications</span>
						</Button>
					</Link>
					<Link href="/homepage/community" className="text-white h-8">
						<Button color="inherit">
